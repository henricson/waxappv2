...
struct WeatherServiceTests {
  ...
  func group2_coldFewDaysNoSnow() async throws {
    ...
    let pastDaily: [DailyHistorySummary] = [
      .init(
        date: day(-1, from: base), temperatureMinC: -6, temperatureMaxC: -3,
        totalPrecipitationMM: 0, snowfallAmountCM: 0, predominantPrecipitation: nil,
        averageHumidity: 0.6),
      .init(
        date: day(-2, from: base), temperatureMinC: -7, temperatureMaxC: -4,
        totalPrecipitationMM: 0, snowfallAmountCM: 0, predominantPrecipitation: nil,
        averageHumidity: 0.6),
      .init(
        date: day(-3, from: base), temperatureMinC: -8, temperatureMaxC: -5,
        totalPrecipitationMM: 0, snowfallAmountCM: 0, predominantPrecipitation: nil,
        averageHumidity: 0.6),
      .init(
        date: day(-4, from: base), temperatureMinC: -8, temperatureMaxC: -4,
        totalPrecipitationMM: 5, snowfallAmountCM: 5, predominantPrecipitation: .snow,
        averageHumidity: 0.7),
    ]
  ...
  func group3_manyColdDaysNoSnow() async throws {
    ...
    let pastDaily: [DailyHistorySummary] = [
      .init(
        date: day(-1, from: base), temperatureMinC: -10, temperatureMaxC: -5,
        totalPrecipitationMM: 0, snowfallAmountCM: 0, predominantPrecipitation: nil,
        averageHumidity: 0.5),
      .init(
        date: day(-2, from: base), temperatureMinC: -9, temperatureMaxC: -6,
        totalPrecipitationMM: 0, snowfallAmountCM: 0, predominantPrecipitation: nil,
        averageHumidity: 0.5),
      .init(
        date: day(-3, from: base), temperatureMinC: -8, temperatureMaxC: -6,
        totalPrecipitationMM: 0, snowfallAmountCM: 0, predominantPrecipitation: nil,
        averageHumidity: 0.5),
      .init(
        date: day(-4, from: base), temperatureMinC: -7, temperatureMaxC: -5,
        totalPrecipitationMM: 0, snowfallAmountCM: 0, predominantPrecipitation: nil,
        averageHumidity: 0.5),
      .init(
        date: day(-5, from: base), temperatureMinC: -6, temperatureMaxC: -4,
        totalPrecipitationMM: 0, snowfallAmountCM: 0, predominantPrecipitation: nil,
        averageHumidity: 0.5),
      .init(
        date: day(-6, from: base), temperatureMinC: -6, temperatureMaxC: -4,
        totalPrecipitationMM: 0, snowfallAmountCM: 0, predominantPrecipitation: nil,
        averageHumidity: 0.5),
      .init(
        date: day(-7, from: base), temperatureMinC: -8, temperatureMaxC: -4,
        totalPrecipitationMM: 5, snowfallAmountCM: 3, predominantPrecipitation: .snow,
        averageHumidity: 0.7),
    ]
  ...
  func group4_wetNoRefreeze() async throws {
    ...
    let pastDaily: [DailyHistorySummary] = [
      .init(
        date: day(-1, from: base), temperatureMinC: 1, temperatureMaxC: 3, totalPrecipitationMM: 0,
        snowfallAmountCM: 0, predominantPrecipitation: .rain, averageHumidity: 0.8)
    ]
  ...
  func group5_refreezeAfterWarm() async throws {
    ...
    let pastDaily: [DailyHistorySummary] = [
      .init(
        date: day(-1, from: base), temperatureMinC: -5, temperatureMaxC: -2,
        totalPrecipitationMM: 0, snowfallAmountCM: 0, predominantPrecipitation: nil,
        averageHumidity: 0.6),
      .init(
        date: day(-2, from: base), temperatureMinC: 0, temperatureMaxC: 3, totalPrecipitationMM: 2,
        snowfallAmountCM: 0, predominantPrecipitation: .rain, averageHumidity: 0.8),
    ]
  ...
  func current_group1_snowNow() async throws {
    ...
    let hours: [HourlyForecastEntry] = [
      .init(
        date: hour(0, from: base), temperatureC: -1, precipitationChance: 0.8, precipitation: .snow,
        relativeHumidity: 0.9, windSpeedKmh: 10, cloudCover: 0.8),
      .init(
        date: hour(1, from: base), temperatureC: -1, precipitationChance: 0.6, precipitation: .snow,
        relativeHumidity: 0.9, windSpeedKmh: 10, cloudCover: 0.8),
    ]
  ...
  func current_group4_wetSoon() async throws {
    ...
    let hours: [HourlyForecastEntry] = [
      .init(
        date: hour(0, from: base), temperatureC: 1.0, precipitationChance: 0.1, precipitation: nil,
        relativeHumidity: 0.6, windSpeedKmh: 5, cloudCover: 0.3),
      .init(
        date: hour(1, from: base), temperatureC: 1.5, precipitationChance: 0.1, precipitation: nil,
        relativeHumidity: 0.6, windSpeedKmh: 5, cloudCover: 0.3),
      .init(
        date: hour(2, from: base), temperatureC: 2.0, precipitationChance: 0.1, precipitation: nil,
        relativeHumidity: 0.6, windSpeedKmh: 5, cloudCover: 0.3),
    ]
  ...
  func current_group2_or_3_coldNoSnow() async throws {
    ...
    let hours2: [HourlyForecastEntry] = [
      .init(
        date: hour(0, from: base), temperatureC: -3, precipitationChance: 0.0, precipitation: nil,
        relativeHumidity: 0.5, windSpeedKmh: 5, cloudCover: 0.2)
    ]
    ...
    let hours3: [HourlyForecastEntry] = [
      .init(
        date: hour(0, from: base), temperatureC: -10, precipitationChance: 0.0, precipitation: nil,
        relativeHumidity: 0.4, windSpeedKmh: 5, cloudCover: 0.2)
    ]
